"""Unit tests for gain family merge."""

from unittest.mock import patch

import xarray as xr

from libera_rad.calibration.combiners.gain_combiner import build_event_dataset
...
@patch("libera_rad.calibration.combiners.gain_combiner.l1a_cal_event_utils.select_and_slice_event_inputs")
