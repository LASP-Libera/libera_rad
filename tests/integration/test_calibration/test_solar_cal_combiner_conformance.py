...
def test_solar_cal_algorithm_end_to_end_ssw_pri_conforms_to_product_definition(
    ...
    monkeypatch.setenv(LIBERA_CAL_OBSID_ENV, "384")
    ...
    assert dataset.attrs["ProductID"] == "SOLAR-SSW-PRI"
