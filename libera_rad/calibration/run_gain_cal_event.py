...
from libera_rad.calibration.gain_combiner import algorithm


def generate_input_manifest(data_dir: Path):
    """Generating test manifest from the data in test_data"""
    # Radiometer L1A data
    rad_sample = data_dir / "LIBERA_L1A_RAD-SAMPLE-DECODED_V5-6-1_20251215T213540_20251215T213625_R26119221206.nc"
    ...
    input_manifest.add_files(rad_sample, nom_hk, cal_full)
