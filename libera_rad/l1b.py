...
def extract_input_dataset(
    ...
    -------
    xr.Dataset
        Radiometer sample dataset matching the data product identifier.

    Raises
    ------
    ValueError
        If dataset matching the data product identifier (i.e. filename containing 'rad_sample') is not found.

    Notes
    -----
    Files are identified by searching for data product identifier substrings in the filename keys.
    """
    ...
    raise ValueError("No dataset not found in input files: " + data_product_identifier.value)
